...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header" style="background-color: magenta;">{{ __('buat mobil') }}</div>
    ...
    <input type="text" class="form-control" name="nama_mobil" aria-describedby="emailHelp">
    </div>
    <div class="mb-3">
    ...
    <input type="text" class="form-control" name="no_kt" aria-describedby="emailHelp">
    </div>
